...
--管理者権限で
--仕様でヘッダは出力できません
--bcp "SELECT * FROM ds100.dbo.product_full" queryout "C:\tmp\ds100\product_full_utf8.csv" -c -C65001 -t , -S 192.168.1.1 -U user01 -P password01
...
--管理者権限で
--仕様でヘッダは出力できません
--bcp "SELECT * FROM ds100.dbo.product_full" queryout "C:\tmp\ds100\product_full_sjis.csv" -c -C932 -t , -S 192.168.1.1 -U user01 -P password01
...
FROM
     'D:\tmp\ds100\product_full.csv' WITH(
         FIRSTROW = 2
        ,DATAFILETYPE = 'char'
        ,CODEPAGE = '65001'
        ,FIELDTERMINATOR = ','
